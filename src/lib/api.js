...
const WEB_MOCK_RESPONSES = {
  ...
  "/patient-portal/facilities/registrations": {
    items: [
      {
        ...
        is_registered_here: true,
        is_verified_here: true,
        phone_verification_status: "verified",
        phone_verified_at: "2026-04-08T10:00:00Z",
        has_visit_history: true,
        visit_count: 4,
        has_appointment_request: true,
        sources: "patient_record,visit,appointment",
      },
      {
        id: "fac-addis-001",
        name: "Addis Clinic",
        ...
        is_registered_here: false,
        is_verified_here: false,
